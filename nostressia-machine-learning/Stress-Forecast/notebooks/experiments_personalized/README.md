...
5. `05_random_forest_personalized_forecast.ipynb`
6. `06_extra_trees_personalized_forecast.ipynb`
7. `07_gradboost_personalized_forecast.ipynb`
8. `08_histgb_personalized_forecast.ipynb`
9. `09_linearsvc_personalized_forecast.ipynb`
10. `10_adaboost_personalized_forecast.ipynb`
11. `11_bagging_tree_personalized_forecast.ipynb`
