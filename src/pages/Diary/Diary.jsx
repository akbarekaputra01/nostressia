  ...
  return (
    ...
    >
      ...
      <main className="flex-grow flex flex-col items-center w-full max-w-[1400px] mx-auto px-4 md:px-8 lg:p-10 z-10 pt-0">
        {/* --- HEADER SECTION (UKURAN DIPERBESAR UNTUK MOBILE S) --- */}
        <motion.div
        ...
        <div className="relative w-full max-w-[1000px] h-[450px] sm:h-[500px] md:h-[600px] flex items-center justify-center perspective-[2000px] mt-0">
          ...
          >
              ...
              <div className="flex-grow p-5 md:p-8 flex flex-col relative z-10">
                ...
                <div className="flex items-center gap-2 mb-2 overflow-x-auto py-2 border-b border-slate-200 no-scrollbar">
                  {moods.map((m) => (
                    <button
                      ...
                      className={`text-xl md:text-2xl hover:scale-110 transition-transform p-1 rounded-lg ${
                        selectedMood === m.emoji ? "bg-blue-50 scale-110" : "opacity-60 grayscale"
                      }`}
                    >
                      {m.emoji}
                    </button>
                ...
                <div className="flex-grow relative flex flex-col overflow-hidden">
                  ...
                  <textarea
                    ...
                    className="flex-grow bg-transparent resize-none focus:outline-none text-slate-700 text-sm md:text-lg leading-[40px] custom-scrollbar w-full relative z-10"
                ...
                <div className="mt-2 flex justify-between items-center pt-2 border-t border-slate-100">
                    ...
                    {fontOptions.map((f) => (
                      <button
                        ...
                        className={`w-6 h-6 rounded-full border text-[10px] flex items-center justify-center transition-all ${
                          selectedFont === f.value ? "bg-slate-800 text-white" : "bg-white text-slate-500"
                        }`}
                      >
                        {f.label}
                      </button>
                  ...
                  <button
                    ...
                    className="px-5 py-2 rounded-lg font-bold text-white shadow-md active:scale-95 text-xs md:text-base"
            ...
            >
              ...
              >
                {/* Border garis oranye - Ikut memudar agar halaman dalam terlihat bersih */}
                <div
                ...
                {/* Konten Utama (Diary Title) dengan transisi fade & scale */}
                <div
              ...
              <div
                className="absolute inset-0 w-full h-full rounded-l-[16px] rounded-r-[4px] shadow-inner bg-[#fcf9f5] border-r border-slate-200"
                ...
                <div className="w-full h-full flex flex-col items-center justify-center p-10 opacity-60">
                  <div className="w-24 h-24 rounded-full bg-slate-200 mb-4 flex items-center justify-center border-4 border-white shadow-sm overflow-hidden">
                    <img
                      src={
                        user?.avatar ||
                        `https://ui-avatars.com/api/?name=${user?.name || "User"}&background=${colors.brandOrange.replace(
                          "#",
                          ""
                        )}&color=fff`
                      }
        ...
        {/* HISTORY SECTION */}
        <div className="w-full max-w-6xl mt-12 md:mt-16 pb-20">
          {entries.length > 0 ? (
            <>
                  ...
                  <AnimatePresence mode="popLayout">
                    {entries.map((entry) => (
                      ...
                      >
                        ...
                        <p
                          className="text-slate-500 text-xs md:text-sm line-clamp-3"
                          style={{ fontFamily: entry.font || baseFont }}
                        >
                          {entry.content}
                        </p>
            ...
            <div className="flex flex-col items-center justify-center py-12 md:py-16 opacity-50 border-2 border-dashed border-slate-200 rounded-3xl w-full">
          ...
          <div className="fixed inset-0 z-[100] flex items-center justify-center p-4">
            ...
            >
                  ...
                  <div className="pb-16">
                    <div className="flex items-start gap-6 mb-0">
                      ...
                      <div className="flex flex-col justify-end h-[64px]">
                        ...
                        <h2
                          className="text-lg md:text-3xl font-extrabold text-slate-800 leading-[32px] h-[32px] truncate"
              ...
              <div className="px-6 py-4 flex justify-end items-center bg-white/50">
                <button
                  onClick={() => setSelectedEntry(null)}
                  className="px-6 py-2 bg-[#1e293b] text-white rounded-lg font-bold text-sm shadow-md hover:bg-slate-700 transition-all active:scale-95"
                >
                  Close Journal
                </button>
              </div>
