        ...
        >
            ...
            <div className="flex justify-between items-center w-full">
                ...
                <div className="flex items-center gap-2 md:gap-4">
                    ...
                    <img
                        ...
                        alt="Profile"
                        className="hidden lg:block w-8 h-8 md:w-10 md:h-10 rounded-full border-2 border-white/20 object-cover cursor-pointer"
                    />
            ...
            <div 
                className={`
                    ...
                    ${isMobileMenuOpen ? "max-h-[400px] mt-4 pt-4 border-t border-gray-200" : "max-h-0 opacity-0"}
                `}
            >
                {navLinks.map((link) => (
                    <Link
                ...
                {/* Hanya muncul di dalam dropdown ini */}
                <div className="w-full border-t border-gray-100 mt-2 pt-3 flex flex-col items-center">
                    <div className="flex items-center gap-3 p-2 rounded-xl hover:bg-gray-50 transition-colors cursor-pointer w-full justify-center">
                        <img
                            src="https://i.pravatar.cc/40?img=12"
                            alt="Profile"
