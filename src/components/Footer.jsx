...
export default function Footer() {
  ...
  return (
    <footer className="relative z-30 mt-6 border-t border-white/40 bg-white/40 backdrop-blur-md">
      <div className="max-w-[1400px] mx-auto px-6 pt-6 pb-3 md:pt-8 md:pb-4">
        <div className="grid grid-cols-1 md:grid-cols-12 gap-6 md:gap-8">
          ...
          <div className="md:col-span-5 flex flex-col gap-2">
            ...
            <p className="text-gray-600 leading-relaxed text-xs md:text-sm pr-10">
          ...
          <div className="md:col-span-3">
            <h3 className="text-gray-900 text-sm font-bold mb-2">Explore</h3>
            <ul className="space-y-1.5">
              <li><Link to="/dashboard" className="text-gray-600 hover:text-blue-600 transition-colors text-xs font-medium">Dashboard</Link></li>
              <li><Link to="/tips" className="text-gray-600 hover:text-blue-600 transition-colors text-xs font-medium">Daily Tips</Link></li>
              <li><Link to="/motivation" className="text-gray-600 hover:text-blue-600 transition-colors text-xs font-medium">Motivation</Link></li>
              <li><Link to="/diary" className="text-gray-600 hover:text-blue-600 transition-colors text-xs font-medium">My Diary</Link></li>
            </ul>
          </div>
        ...
        {/* COPYRIGHT SECTION */}
        <div className="mt-6 pt-3 border-t border-gray-200/50 flex flex-col md:flex-row items-center justify-between gap-2 text-[11px] text-gray-400 font-medium">
