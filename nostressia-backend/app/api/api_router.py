...
from app.routes.stress_insight_route import router as stress_insight_router
...
api_router.include_router(stress_insight_router)
api_router.include_router(user_auth_router, prefix="/auth", tags=["Auth"])
