    ...
    <div className="bg-surface-elevated p-5 md:p-6 rounded-3xl shadow-xl border border-border w-full max-w-[320px] md:max-w-sm rotate-2 hover:rotate-0 transition-transform duration-500 relative group z-10 mx-auto">
       ...
       <div className="flex items-end justify-between gap-2 h-28 md:h-32 mb-2 px-1">
          {[40, 65, 30, 85, 50, 20, 60].map((h, i) => (
             <div key={i} className="w-full bg-surface-muted rounded-t-lg relative group-hover:bg-brand-primary/10 transition-colors h-full flex items-end">
                <Motion.div 
                   initial={{ height: 0 }}
...
const MotivationCard = () => (
    <div className="bg-surface-elevated p-5 md:p-6 rounded-3xl shadow-xl border border-border w-full max-w-[320px] md:max-w-sm rotate-[-1deg] hover:rotate-0 transition-transform duration-500 relative z-10 mx-auto">
      ...
      <div className="bg-gradient-to-br from-brand-accent to-brand-warning rounded-2xl p-5 md:p-6 text-text-inverse relative overflow-hidden group-hover:shadow-lg transition-shadow">
         ...
         <p className="text-[10px] md:text-xs text-text-inverse/80 mt-3 md:mt-4 font-medium text-right opacity-90">- T. Roosevelt</p>
      </div>
    </div>
);
       ...
       <div className="flex-1 border-r border-border p-4 relative flex flex-col">
           ...
           <div className="space-y-3 md:space-y-4">
               <div className="flex gap-2 items-start">
                   <div className="w-6 md:w-8 text-[8px] md:text-[10px] text-text-muted font-bold text-right pt-1">OCT 12</div>
  ...
  return (
   ...
   >
      ...
      >
         ...
         <Motion.div variants={itemVariants} className="flex justify-between items-center mb-6 px-1">
            <div className="flex items-center gap-3">
               <Motion.img 
                  ...
                  src={Avatar1} alt="User" className="w-10 h-10 rounded-full border-2 border-brand-primary object-cover cursor-pointer" 
               />
               <div>
                  <p className="text-[10px] text-text-muted font-bold uppercase tracking-wide">Good Morning,</p>
                  <p className="text-sm font-bold text-text-primary dark:text-text-primary">PPTI Student</p>
               </div>
            </div>
            <Motion.div 
         ...
         <Motion.div variants={itemVariants} className="bg-brand-primary rounded-[1.5rem] p-5 text-text-inverse mb-4 relative overflow-hidden group">
         ...
         <Motion.div variants={itemVariants} className="mt-6 flex justify-around text-text-muted/70 border-t border-border-subtle pt-4">
    ...
    <header className="relative z-10 pt-20 pb-10 md:pt-28 md:pb-16 px-6 overflow-hidden flex flex-col md:justify-center md:min-h-[90vh]">
      ...
      <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
        ...
        >
          ...
          >
            {/* LINK GET STARTED */}
            <Link to="/login" className="px-8 py-4 bg-surface-muted text-text-primary rounded-full font-bold text-base shadow-xl hover:shadow-2xl hover:scale-105 transition-all duration-300 flex items-center justify-center gap-2 group hover:bg-brand-accent hover:border-brand-accent cursor-pointer dark:bg-surface dark:text-text-primary dark:hover:bg-surface-muted">
   ...
   return (
      <>
         ...
         >
            ...
            <Link to="/login" className="px-6 py-3 bg-surface-muted text-text-primary rounded-full font-bold text-sm shadow-xl hover:shadow-2xl hover:bg-brand-primary hover:-translate-y-0.5 transition-all cursor-pointer flex items-center gap-2 dark:bg-surface dark:text-text-primary dark:hover:bg-surface-muted">
  ...
  return (
    <div className="min-h-screen font-sans bg-surface dark:bg-surface text-text-primary dark:text-text-primary overflow-x-hidden selection:bg-brand-accent selection:text-text-inverse">
      ...
      <div className="fixed inset-0 z-0 opacity-[0.4] pointer-events-none"
           style={{ backgroundImage: 'radial-gradient(rgb(var(--neutral-200)) 1px, transparent 1px)', backgroundSize: '32px 32px' }}>
      </div>
         ...
         <div id="prediction" className="scroll-mt-32">
           ...
           <div className="md:hidden space-y-8">
              <div className="text-center space-y-3">
                    ...
                    <h2 className="text-3xl font-bold text-text-primary dark:text-text-primary">Don't bottle it up.<br/>Track it.</h2>
           ...
           <div className="hidden md:flex flex-row items-center gap-24">
              ...
              <div className="flex-1 space-y-6 text-left">
                 ...
                 <h2 className="text-5xl font-bold text-text-primary dark:text-text-primary">Don't bottle it up. <br/>Track it.</h2>
         ...
         <div id="analytics" className="scroll-mt-32">
             ...
             <div className="md:hidden space-y-8">
                <div className="text-center space-y-3">
                     ...
                     <h2 className="text-3xl font-bold text-text-primary dark:text-text-primary">See the big picture.</h2>
                     <p className="text-base text-text-muted leading-relaxed px-2">
             ...
             <div className="hidden md:flex flex-row-reverse items-center gap-24">
                ...
                <div className="flex-1 space-y-6 text-left">
                   ...
                   <h2 className="text-5xl font-bold text-text-primary dark:text-text-primary">See the big picture.</h2>
                   <p className="text-lg text-text-muted leading-relaxed">
         ...
         <div id="motivation" className="scroll-mt-32">
             ...
             <div className="md:hidden space-y-8">
                <div className="text-center space-y-3">
                     ...
                     <h2 className="text-3xl font-bold text-text-primary dark:text-text-primary">Find your spark.</h2>
                     <p className="text-base text-text-muted leading-relaxed px-2">
             ...
             <div className="hidden md:flex flex-row items-center gap-24">
                ...
                <div className="flex-1 space-y-6 text-left">
                   ...
                   <h2 className="text-5xl font-bold text-text-primary dark:text-text-primary">Find your spark.</h2>
                   <p className="text-lg text-text-muted leading-relaxed">
         ...
         <div id="tips" className="scroll-mt-32">
             ...
             <div className="md:hidden space-y-8">
                <div className="text-center space-y-3">
                     ...
                     <h2 className="text-3xl font-bold text-text-primary dark:text-text-primary">Rest & Reset.</h2>
                     <p className="text-base text-text-muted leading-relaxed px-2">
             ...
             <div className="hidden md:flex flex-row-reverse items-center gap-24">
                ...
                <div className="flex-1 space-y-6 text-left">
                   ...
                   <h2 className="text-5xl font-bold text-text-primary dark:text-text-primary">Rest & Reset.</h2>
                   <p className="text-lg text-text-muted leading-relaxed">
         ...
         <div id="diary" className="scroll-mt-32">
             ...
             <div className="md:hidden space-y-8">
                <div className="text-center space-y-3">
                     ...
                     <h2 className="text-3xl font-bold text-text-primary dark:text-text-primary">Dear Diary.</h2>
                     <p className="text-base text-text-muted leading-relaxed px-2">
             ...
             <div className="hidden md:flex flex-row items-center gap-24">
                ...
                <div className="flex-1 space-y-6 text-left">
                   ...
                   <h2 className="text-5xl font-bold text-text-primary dark:text-text-primary">Dear Diary.</h2>
                   <p className="text-lg text-text-muted leading-relaxed">
