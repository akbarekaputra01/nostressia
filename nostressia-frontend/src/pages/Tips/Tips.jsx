...
const TIP_STYLE_PRESETS = [
  {
    emoji: "📚",
    colorClass: "from-brand-primary/10 to-brand-primary/20 text-brand-primary border-brand-primary/20",
  },
  {
    emoji: "🥗",
...
export default function Tips() {
  ...
  return (
    <div className="min-h-screen text-text-primary dark:text-text-primary flex flex-col" style={bgStyle}>
