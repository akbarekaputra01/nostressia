              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-6">
                {getVerticalOrderedTips(selectedCategory.tips).map((tip, idx) => (
                  <Motion.div 
                    ...
                    className="bg-white px-6 py-4 md:px-8 md:py-5 rounded-[24px] md:rounded-[28px] border border-gray-200 shadow-sm relative group hover:bg-white transition-colors overflow-hidden flex items-center min-h-[80px] md:min-h-[90px]"
                  >
